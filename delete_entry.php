...
<body>
    ...
    if (isset($_GET['id']) && is_numeric($_GET['id']) ) { // Display the entry in a form:
        ...
        if ($r = mysqli_query($dbc, $query)) { // Run the query.
            ...
            print '<p style="color: red;">Could not retrieve the blog entry because:<br>' . mysqli_error($dbc) . '.</p><p>The query was being run was: ' . $query . '</p>';
        }
        ...
        print '<p style="color: red;">This page has been access in error.</p>';
    } // End of main IF
